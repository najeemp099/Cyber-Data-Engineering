...
RESULTS_PATH = "results/spark_benchmark_results.csv"
...
def create_spark_session():
    ...
    spark = (
        ...
        .appName("CyberScaleData-Benchmark")
        .master("local[*]")
        .config(
...
def prepare_data(df):
    ...
    # Convert features to double and replace null/NaN values
...
def main():
    ...
    print("=" * 60)
    print("CyberScaleData - PySpark Scalability Benchmark")
    print("=" * 60)
    ...
    print("=" * 80)
    print("PySpark scalability benchmark completed successfully")
    print("=" * 80)
